...
*/
$( function() {
        var endDate = "April  29, 2020 17:01:25";
        ...
        $('.countdown.styled').countdown({
          ...
          render: function(data) {
            $(this.el).html("<div>" + this.leadingZeros(data.days, 2) + " <span>дней</span></div><div>" + this.leadingZeros(data.hours, 2) + " <span>ч.</span></div><div>" + this.leadingZeros(data.min, 2) + " <span>мин.</span></div><div>" + this.leadingZeros(data.sec, 2) + " <span>сек.</span></div>");
          }
        });
